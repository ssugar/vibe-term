...
must_haves:
  ...
  artifacts:
    - path: "src/services/paneSessionManager.ts"
      ...
      exports: ["ensureScratchWindow", "createSessionPane", "getSessionPane", "switchToSession", "getActiveSessionId"]
...
Verify all 5 functions exist: `grep -cE "(ensureScratchWindow|createSessionPane|getSessionPane|switchToSession|getActiveSessionId)" src/services/paneSessionManager.ts` (should output 5)
  </verify>
  <done>
